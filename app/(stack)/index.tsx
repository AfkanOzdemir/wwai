  ...
  const data = [
    {
      ...
      image: "https://cdn.pixabay.com/photo/2024/06/06/08/40/ai-generated-8812169_1280.jpg",
      shortDescription: "Merhaba, ben Albert Einstein. Fizikçi, matematikçi ve filozofum...",
      description: "Merhaba, ben Albert Einstein. Fizikçi, matematikçi ve filozofum. 14 Mart 1879 tarihinde Almanya'nın Württemberg Krallığı'na bağlı Ulm şehrinde doğdum. 18 Nisan 1955 tarihinde ABD'nin New Jersey eyaletine bağlı Princeton şehrinde hayata gözlerimi yumdu. 20. yüzyılın en önemli fizikçilerinden biri olarak kabul edilirim. Beni tanımanızı çok isterim.",
      properties: [
        {
          id: 1,
          name: "Zeka",
      ...
      image: "https://cdn.pixabay.com/photo/2023/10/12/16/11/ai-generated-8311192_1280.png",
      shortDescription: "Merhaba, ben Leonardo Da Vinci. Ünlü İtalyan ressamım...",
      description: "Merhaba, ben Leonardo Da Vinci. Rönesans döneminin İtalyan ressamı, bilim insanı, matematikçi, mühendis, anatomist, mucit, heykeltıraş, mimar, müzisyen, yazar, filozof ve botanikçiyim. 15 Nisan 1452 tarihinde İtalya'nın Vinci şehrinde doğdum. 2 Mayıs 1519 tarihinde Fransa'nın Amboise şehrinde hayata gözlerimi yumdu. Beni tanımanızı çok isterim.",
      properties: [
        {
          id: 1,
          name: "Sanat",
      ...
      <View className="flex-1 bg-background p-4">
        <View className="flex-2 rounded-xl overflow-hidden relative">
          <Image
            ...
            transition={100}
          />
          <LinearGradient colors={["transparent", "#161622"]} className="w-full h-full absolute bottom-0 z-10">
